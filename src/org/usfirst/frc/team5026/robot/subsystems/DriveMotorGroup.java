...
public class DriveMotorGroup extends Subsystem {
   ...
   // here. Call these from Commands.
	 ...
	 * @param power_level The power level of the motor group. Range: -1 to 1 (inclusive).
	 */
	public void set(float power_level) {for(int i = 0;i<motors.length;i++) {motors[i].set(power_level);}}
	/**
	 * Sets the motor group speeds to 0
	 * @param motor_id The id that represents the motor you wish to stop. Range: 0 to 3 (inclusive);
	 */
	public void stop() {for(int i = 0;i<motors.length;i++) {this.motors[i].set(0);}}
